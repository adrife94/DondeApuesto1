    ...
    public static List<Cuotas> parseador(String casa, String liga, String url, Date date) {
        ...
        try {
            ...
            for (int i = 0; i < eventos.size(); i++) {
                ...
                switch (liga) {
                    case "LaLiga":
                        equipo = EstandarizadorNombresKirolbet.estandarizadorEquiposLaLiga(b);
                        listaPartidos.add(equipo);
                        break;
                    case "Bundesliga":
                        equipo = EstandarizadorNombresKirolbet.estandarizadorEquiposBundesliga(b);
                        listaPartidos.add(equipo);
                        break;
                    case "Premier":
                        equipo = EstandarizadorNombresKirolbet.estandarizadorEquiposPremier(b);
                        listaPartidos.add(equipo);
                        break;
                    case "Calcio":
                        equipo = EstandarizadorNombresKirolbet.estandarizadorEquiposCalcio(b);
                        listaPartidos.add(equipo);
                        break;
                    case "Eredivise":
                        equipo = EstandarizadorNombresKirolbet.estandarizadorEquiposEredivise(b);
                        listaPartidos.add(equipo);
                        break;
                    case "Ligue1":
                        equipo = EstandarizadorNombresKirolbet.estandarizadorEquiposLigue1(b);
                        listaPartidos.add(equipo);
                        break;
                    case "Primeira":
                        equipo = EstandarizadorNombresKirolbet.estandarizadorEquiposPrimeira(b);
                        listaPartidos.add(equipo);
                        break;
                }
            }
