...
public class Betway {
    public static List<Cuotas> parseador(String casa, String liga, String url ) {
        ...
        try {
            ...
            Document betway = Jsoup.connect(url).get();
            System.out.println(betway);
            Elements equipos = betway.getElementsByClass("teamNameFirstPart teamNameHomeTextFirstPart");
            Elements cuo = betway.select("ul[des=1X2]");
