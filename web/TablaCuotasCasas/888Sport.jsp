...
<nav>
    <ul class="nav">
        ...
        <li><a href= "https://es.wikipedia.org/wiki/S%C3%ADdney">Bet365</a></li>
        <li><a href= "https://es.wikipedia.org/wiki/Melbourne">Sportium</a></li>
        <li><a href= "https://es.wikipedia.org/wiki/S%C3%ADdney">Suertia</a></li>
        <li><a href= "https://es.wikipedia.org/wiki/Melbourne">888Sport</a></li>
        <li><a href= "https://es.wikipedia.org/wiki/S%C3%ADdney">Retabet</a></li>
        <li><a href= "https://es.wikipedia.org/wiki/Melbourne">Codere</a></li>
        <li><a href= "https://es.wikipedia.org/wiki/S%C3%ADdney">Bet365</a></li>
...
<table>
    ...
    <tr>
        ...
        <th></th>
        <th></th>
        <th class="resultadotabla">Local</th>
        <th class="resultadotabla">Empate</th>
        <th class="resultadotabla">Visitante</th>
        <th class="resultadotabla">Porcentaje de Pago</th>
